...
class VSCO:
    ...
    def download_images(self):
        ...
        concurrent(self._download_vsco_media, data, executor="threadpool", progress_bar=True, desc="Downloading {}'s images".format(self.username))
    ...
    def download_journal(self):
        ...
        write_dict_to_file("{}_journal_undownloadable.json".format(self.username), undownloadable_links)

        # Concurrently download all media
        concurrent(self._download_vsco_media, data, executor="threadpool", progress_bar=True, desc="Downloading {}'s journal images".format(self.username))
        # Change directory back into master path
        os.chdir(self.userpath)
